  ...
  return (
    <div className=' hover:scale-110 transition-all ease-in-out'>
        <div className='w-[300px] fold:w-[250px] fold:h-[400px] h-[450px] m-4 shadow-[0.2px_2px_5px_rgba(255,193,7,0.4)] relative overflow-hidden rounded-[3px]'>
            ...
            <div className={type ? ' text-amber-custom top-0 right-0  absolute p-1  flex items-center justify-center capitalize  ' : ' text-[#FF0800] top-0 right-0  absolute p-1  flex items-center justify-center capitalize  '}><span className=' p-2 bg-gray-900/80 rounded-[10px] font-bold shadow-miniCardShadow'>{type ? type : "No Type"}</span></div>
